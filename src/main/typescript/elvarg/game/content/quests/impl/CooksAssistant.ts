...
export class CooksAssistant implements Quest {
    ...
    firstClickNpc(player: Player, npc: NPC) {
        ...
        switch (QuestHandler.COOKS_ASSISTANT.getProgress(player)) {
            case 'NOT_STARTED':
    ...
    private buildDialogues() {
        ...
        this.dialogueBuilder.add(
            new NpcDialogue(0, CooksAssistant.NPC_COOK, "What am I to do?", DialogueExpression.DialogueExpressions.SAD),
            new OptionDialogue(1, new Map<string, (player: Player) => void>([
                ["What's wrong?", (player) => player.getDialogueManager().startDialogue(2)],
                ["Can you cook me a cake?", (player) => player.getDialogueManager().startDialogue(14)],
                ["You don't look very happy.", (player) => player.getDialogueManager().startDialogue(2)],
                ["Nice hat.", (player) => player.getDialogueManager().startDialogue(17)]
            ])),
            ...
            new NpcDialogue(3, CooksAssistant.NPC_COOK,
                ...
                "making him a lovely big birthday cake!", DialogueExpression.DialogueExpressions.SAD),
            new NpcDialogue(4,CooksAssistant. NPC_COOK,
                ...
                "me? Please?", DialogueExpression.DialogueExpressions.SAD),
            new OptionDialogue(5, new Map<string, (player: Player) => void>([
                ["I'm always happy to help a cook in distress.", (player) => {
                    QuestHandler.COOKS_ASSISTANT.setProgress(player, 1);
                    player.getDialogueManager().start(6);
                }],
                ["I can't right now, Maybe later.", (player) => player.getDialogueManager().start(11)]
            ])),

            new PlayerDialogue(6, "Yes, I'll help you.", DialogueExpression.DialogueExpressions.HAPPY),
            new NpcDialogue(7, CooksAssistant.NPC_COOK, "Oh thank you, thank you. I need milk, an egg, and " +
                "flour. I'd be very grateful if you can get them for me.", DialogueExpression.DialogueExpressions.HAPPY),
            new PlayerDialogue(8, "So where do I find these ingredients then?", DialogueExpression.DialogueExpressions.DISTRESSED),
            ...
            new PlayerDialogue(11, "I can't right now, Maybe later.", DialogueExpression.DialogueExpressions.SAD),
            new NpcDialogue(12, CooksAssistant.NPC_COOK, "Oh please! Hurry then!", DialogueExpression.DialogueExpressions.DISTRESSED),
            new EndDialogue(13),

            new PlayerDialogue(14, "Can you bake me a cake?", DialogueExpression.DialogueExpressions.EVIL_LAUGH_SHORT),
            new NpcDialogue(15, CooksAssistant.NPC_COOK, "Does it look like I have the time?", DialogueExpression.DialogueExpressions.ANGRY_1),
            new EndDialogue(16),

            new PlayerDialogue(17, "Nice hat!", DialogueExpression.DialogueExpressions.EVIL_LAUGH_SHORT),
            new NpcDialogue(18, CooksAssistant.NPC_COOK, "I don't have time for your jibber-jabber!", DialogueExpression.DialogueExpressions.ANGRY_1),
            new EndDialogue(19),

            new NpcDialogue(20, CooksAssistant.NPC_COOK, "How are you getting on with finding the ingredients?", DialogueExpression.DialogueExpressions.DISTRESSED, (player) => {
            ...
            new NpcDialogue(22, CooksAssistant.NPC_COOK, "You brought me everything I need! I'm saved!", DialogueExpression.DialogueExpressions.HAPPY, (player) => {
                ...
                QuestHandler.COOKS_ASSISTANT.setProgress(player, 2);
            }),
            ...
            new NpcDialogue(25, CooksAssistant.NPC_COOK, "I'm afraid not, only the big cheeses get to dine with the"
                + "Duke.", DialogueExpression.DialogueExpressions.SLIGHTLY_SAD),
            new PlayerDialogue(26, "Well, maybe one day I'll be important enough to sit on" +
                "the Duke's table"),
            new NpcDialogue(27, CooksAssistant.NPC_COOK, "Maybe, but I won't be holding my breath.", DialogueExpression.DialogueExpressions.LAUGHING, (player) => {
                QuestHandler.COOKS_ASSISTANT.showRewardInterface(player, new String[] { "1 Quest Point", "500 Coins", "300 Cooking XP", "", "", "" }, 326);
                player.getInventory().add(995, 500);
                player.getSkillManager().addExperience(Skill.COOKING, 300);
                player.getPacketSender().sendMessage("You completed " + QuestHandler.COOKS_ASSISTANT.getName() + "!");
                //client.getActionSender().sendQuickSong(93, 0);
            }),

            new PlayerDialogue(24, "I don't have all the ingredients yet!", DialogueExpression.DialogueExpressions.SAD),
            new EndDialogue(25)
        );
    }
}
