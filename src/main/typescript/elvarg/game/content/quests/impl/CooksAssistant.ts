...
export class CooksAssistant implements Quest {
    ...
    private buildDialogues() {
        ...
        this.dialogueBuilder.add(
            ...
            new OptionDialogue(1, {
                executeOption: (player: Player) => player.getDialogueManager().startDialogue(2),
                options: new Map<string, (player: Player) => void>([
            ...
            new NpcDialogue(20, CooksAssistant.NPC_COOK, "How are you getting on with finding the ingredients?", DialogueExpression.DISTRESSED, (player) => {
            ...
            new NpcDialogue(22, CooksAssistant.NPC_COOK, "You brought me everything I need! I'm saved!", DialogueExpression.HAPPY, (player) => {
            ...
            new PlayerDialogue(26, "Well, maybe one day I'll be important enough to sit on" +
                "the Duke's table"),
            new NpcDialogue(27, CooksAssistant.NPC_COOK, "Maybe, but I won't be holding my breath.",DialogueExpression.LAUGHING, (player) => {
                Quests.COOKS_ASSISTANT.showRewardInterface(player, new String[] { "1 Quest Point", "500 Coins", "300 Cooking XP", "", "", "" }, 326);
